...
class BlockPushLowdimRunnerFixed(BaseLowdimRunner):
    def __init__(self,
            output_dir,
            n_train=10,
            n_train_vis=3,
    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(total=self.max_steps, desc=f"Eval BlockPushLowdimRunnerFixed {chunk_idx+1}/{n_chunks}", 
